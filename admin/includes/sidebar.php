  ...
  padding-left: 10px;
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
        ...
        <ul class="list-group">
            ...
            <a href="add_books.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Add Books</span>
                </a>
            ...
            <a href="add_admin.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Add Admin</span>
                </a>
                <a href="view_admin.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Admin list</span>
                </a>
                <a href="view_user.php" class="list-group-item list-group-item-action bg-dark text-white">
